            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-2.5 mb-3">
                        <div className="w-10 h-10 bg-[#B58863]/10 border border-[#B58863]/20 rounded-xl flex items-center justify-center">
                            <LogIn className="w-5 h-5 text-[#B58863]" />
                        </div>
                    ...
                    <p className="text-[#A79E9C] font-light">
                        Sign in to master architectural interviews
                    </p>
                </div>
                ...
                <div className="bg-[#161616] rounded-2xl p-8 shadow-xl border border-white/[0.04] relative">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full glass-btn-primary flex items-center justify-center hover:scale-[1.02] active:scale-[0.98]"
                            disabled={loading}
                        >
                            {loading ? (
                                <>
